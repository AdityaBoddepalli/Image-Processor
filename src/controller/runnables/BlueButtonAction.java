...
/**
 * The button for Blue Component.
 */
public class BlueButtonAction extends AbstractButtonAction {
   ...
   * @param view the view
   */
  public BlueButtonAction(ImageProcessor model, GUIView view) {
    super(model, view);
  }
  ...
  protected String specificAction() throws IOException {
    ...
    this.model.extractComponent(this.view.currImageName(), destName, "blue");
    return destName;
  }
}
