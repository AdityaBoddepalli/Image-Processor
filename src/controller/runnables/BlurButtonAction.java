...
/**
 * The button for Blurring an image.
 */
public class BlurButtonAction extends AbstractButtonAction {
   ...
   * @param view the view
   */
  public BlurButtonAction(ImageProcessor model, GUIView view) {
    super(model, view);
  }
  ...
  protected String specificAction() throws IOException {
    ...
    this.model.filterImage(this.view.currImageName(), destName, "blur");
    return destName;
  }
}
