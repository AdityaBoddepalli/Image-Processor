...
/**
 * The button for putting an image in greyscale.
 */
public class GreyscaleButtonAction extends AbstractButtonAction {
   ...
   * @param view the view
   */
  public GreyscaleButtonAction(ImageProcessor model, GUIView view) {
    super(model, view);
  }
  ...
  protected String specificAction() throws IOException {
    ...
    this.model.filterImage(this.view.currImageName(), destName, "greyscale");
    return destName;
  }
}
